...
$_SESSION['Message']="<div style='color:green;padding:5px;text-align:center;border:1px solid #aea;background-color:#efe;'>Teacher/Student Information Successfully Saved</div>";	

}
else{
	$_Error=mysqli_error($con);
	$_SESSION['Message']="<div style='color:red;padding:5px;text-align:center;border:1px solid #eaa;background-color:#fee;'>Teacher/Student Information Failed to save,Error:$_Error</div>";	
...
<div class="main-platform" align="center" >
	...
	<table border="0" width="100%">
		<tr>
			...
			<form method="post" id="formID" name="formID" action="register-student.php">
      ...
      <br/><br/>
			...
			<div align="center"><button class="button-save" id="register_user" name="register_user"><i class="fa fa-save"></i> SAVE STUDENT</button></div>
		</form>
