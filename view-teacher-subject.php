...
//Registered clients
				echo "<table width='100%' style='background-color:white'>";
				echo "<caption>List Of Subjects</caption>";
				echo "<thead><th width='20%'>Class</th><th>Semester</th><th>Batch</th><th>Subject Id</th><th>Subject</th><th>Entry Date/Time</th><th>Status</th></thead>";
				echo "<tbody>";
...
echo "</tr>";
*/
$_SQL_CLASS=mysqli_query($con,"SELECT * FROM tblclassentry ce INNER JOIN tblsubjectassignment sa ON ce.class_entryid=sa.classid WHERE sa.userid='$_SESSION[USERID]'");
