...
{
$_SQL_SU=mysqli_query($con,"SELECT * FROM tblsystemuser su WHERE su.systemtype='Student'");
...
$_SQL_CLASS=mysqli_query($con,"SELECT * FROM tblclassentry ce INNER JOIN tbltermregistry tr 
ON ce.class_entryid=tr.class_entryid WHERE tr.userid='$row_rsu[userid]' AND tr.batchid='$_Batch_ID'");
